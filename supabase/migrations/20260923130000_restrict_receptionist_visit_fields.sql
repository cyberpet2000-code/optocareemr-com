-- Restrict receptionist visit history to operational dispensing fields only.
-- Clinical case history, VA, examination, IOP, diagnosis and notes are not returned.
