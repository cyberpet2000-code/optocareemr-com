-- Keep receptionist visit history aligned with the live RPC.
-- Receptionists may see only completed-visit fields needed for HMO requests,
-- billing, prescription fulfilment and dispensing; detailed clinical findings
-- remain excluded.
...
begin
  ...
  return query
  select
    v.id, v.patient_id, v.clinic_id, v.doctor_id,
